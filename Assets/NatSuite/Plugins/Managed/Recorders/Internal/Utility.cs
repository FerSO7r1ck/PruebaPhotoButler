...
namespace NatSuite.Recorders.Internal {
    ...
    public static class Utility {
        ...
        public static string GetPath (string extension) {
            ...
            //var name = !(AERuntimeLoaderThreeLayer.Instance.GetRecordName() == String.Empty) ? $"{AERuntimeLoaderThreeLayer.Instance.GetRecordName()}{extension}" : $"recording_{timestamp}{extension}";
